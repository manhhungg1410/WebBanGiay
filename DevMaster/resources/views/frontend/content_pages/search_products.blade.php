    ...
    <div class="bg0 m-t-23 p-b-140">
        <div class="container">
                ...
                <div class="dis-none panel-search w-full p-t-10 p-b-15">
                    <form action="{{route('searchProducts')}}" method="get">
                        ...
                        <div class="bor8 dis-flex p-l-15">
                            ...
                            <input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" value="{{$name}}" name="search" placeholder="Search">
            ...
            <div class="flex-c-m flex-w w-full p-t-45">
                {{$lsProducts->appends(['search'=>$name])->links("pagination::bootstrap-4")}}
            </div>
        </div>
    </div>
