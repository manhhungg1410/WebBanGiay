        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="post" action="{{route('adminpolicies.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="form-group">
                                <label for="name">Name of Policy (<span style="color: red;">*</span>):</label>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Name of Policy...">
                            </div>
