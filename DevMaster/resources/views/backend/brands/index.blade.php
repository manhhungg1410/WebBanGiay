...
@section('content')
        ...
        <section class="content-header">
            <h1>
                Brands Management
                <small>All Brands in Website.</small>
            </h1>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <a href="{{route('adminbrands.create')}}" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add New Brand</a>
                            {{--                                    SEARCH--}}
                            <div class="box-tools">
                                <form action="{{route('adminbrands.index')}}" method="get">
...
{{--
                        {{--        BẢNG RECORD            --}}
                        <form id="idForm" action="{{route('admindeleteAll')}}">
                        @csrf
{{--                        @method('DELETE')--}}
                        <!-- /.box-header -->

                        <button type="submit" data-toggle="tooltip" class="delete btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete all selected</button>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="{{route('adminbrands.edit',$items->id)}}"> <span class="glyphicon glyphicon-edit"></span> Edit</a>
{{--                                            <form action="{{route('adminbrands.destroy',$items->id)}}" method="post">--}}
{{--                                                @csrf--}}
{{--                                                @method('DELETE')--}}
...
{{--                                            </form>--}}
            ...
            {{$lsBrands->appends(['name'=>$name])->links("pagination::bootstrap-4")}}
            </div>
            {{--  HẾT PHÂN TRANG   --}}
